/*
In a parking lot, the first hour (or fraction) costs Bs. 100 and each additional hour (or fraction) Bs. 80. Create an algorithm that receives as input the entry time and exit time of a vehicle and calculates the amount to be paid.
*/
#include <iostream>
