/*
Create an algorithm that takes as input the exact time (hours, minutes,
seconds, and AM/PM) and returns the number of seconds elapsed during that day.
*/
#include <iostream>
#include <string>
...
int main(int argc, char *argv[]) {
  ...
  std::cout << "A las " << hora << ':' << minuto << ':' << segundo << ' '
            << turno << ' ';
