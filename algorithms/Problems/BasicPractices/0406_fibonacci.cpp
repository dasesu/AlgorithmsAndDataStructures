/*
Write an algorithm that takes as input a number N and prints the Fibonacci
sequence up to N. The Fibonacci sequence starts with the numbers 0 and 1 and is
calculated at each step by adding the last two numbers in the sequence. For
example, the first few numbers in the Fibonacci sequence are 0, 1, 1, 2, 3, 5,
8, 13,
*/
#include <iostream>
