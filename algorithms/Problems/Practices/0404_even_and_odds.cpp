/*
Given a sequence of numbers ending in zero, develop an algorithm
to calculate the percentage and sum of odd numbers, the percentage
and sum of even numbers, and the sum of all numbers, and how many
